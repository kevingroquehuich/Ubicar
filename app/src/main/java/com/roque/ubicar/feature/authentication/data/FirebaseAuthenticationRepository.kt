package com.roque.ubicar.feature.authentication.data
...
class FirebaseAuthenticationRepository(
    ...
    override suspend fun oneTapLogin(): Result<Unit> {
        ...
        return try {
            ...
            if (firebaseResult.user == null) return Result.failure(Exception("Failed to sign in, please try again later"))
            Result.success(Unit)
        } catch (e: Exception) {
            Result.failure(e)
        }
